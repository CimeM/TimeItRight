...
//  Time it right!
//
//  Created by Martin Cimerman on 25/05/16.
...
struct GameData02 {
    ...
    var latestScores        = [0] // saved last 7 scores
    ...
    /**
     ...
     its update is latestScore
     */
    mutating func updateHighscoresInNSUser(latestScore : Int) -> GameData02 {
        

        //loadHighscores () // get data from NSUser
